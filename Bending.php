...
$records = mysqli_query($conn,"SELECT * FROM accepted ORDER BY orderid DESC"); // fetch data from database
      ...
      <section class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url('https://picklaptop.com/wp-content/uploads/2020/04/best-laptops-for-genealogy-in-2020-thumbnail-.jpg');">
        <div class="container h-100">
           ...
           <div class="container-fluid" style="margin:4%;">  
                <h1 align="center">ORDERS BENDING : <?php echo $count?></h1>  
                                       ...
                                       <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><h4><?php echo $data['description']; ?> </h4></td>
                                                    ...
                                                    <button class="btn btn-primary completed"><a href="completed.php?id=<?php echo $data['orderid']; ?>">
                                                    <i class="fa fa-check fa-1x" ></i> Completed</a></button>
